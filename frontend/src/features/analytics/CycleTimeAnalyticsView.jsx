...
import { BarChart3, Clock, AlertTriangle, CheckCircle2, Zap, RotateCcw, Info } from "lucide-react";
import { fetchCycleTimeAnalytics } from "../../api/ticketAnalytics";
import "./analytics.css";

/**
 * ARCHITECTURAL DECISION NOTE: Route-based Feature Gating (ADR-001)
 *
 * This component is designed to be rendered within the dedicated `/admin/metricas` route.
 * Isolating analytics in its own route allows declarative feature gating via Route Guards
 * (e.g., <PlanGuard requiredFeature="cycle_analytics">) or showing upgrade paywalls
 * without modifying or bloating AdminDashboard.jsx.
 */
...
export default function CycleTimeAnalyticsView({ isModal = false }) {
  ...
  return (
    <div className={isModal ? "analytics-view-inner" : "analytics-view-card"}>
      {/* Toolbar */}
