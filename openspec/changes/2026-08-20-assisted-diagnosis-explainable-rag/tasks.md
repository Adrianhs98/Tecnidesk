...
- [ ] 3. Phase 3: Grounded Reasoning Layer & Explainability
  ...
  - [ ] 3.2 Implement `backend/app/services/explanation_service.py` using `gemini-3.7-flash` (high thinking effort, zero temperature, structured JSON schema output, and closed-world prompt)
