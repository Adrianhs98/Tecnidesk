...
- **And** draft_diagnostic is currently 
ull
...
- **And** Ticket.draft_diagnostic remains 
ull, leaving the single-generation allowance unconsumed
...
- **Given** a ticket where draft_diagnostic is 
ull
...
- **When** the technician clicks Generar Diagnóstico and the call succeeds
- **Then** the generated draft is displayed in an editable review area
- **And** the Generar Diagnóstico button is disabled or hidden
